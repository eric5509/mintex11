...
export default function Links({ data, fontSize, identifier, setActive, active, paddingInline, marginRight, radius, marginLeft, height, noRadius }: Props) {
