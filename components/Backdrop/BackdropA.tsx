...
export default function BackdropA() {
    ...
    return (
        <div className={`fixed w-full hidden z-[500] bg-black/20 duration-300 overflow-hidden backdrop-blur-xl h-[calc(100vh-80px)] top-[80px] left-0 lg:grid place-content-center ${backdrop === 1 ? "opacity-100 visible": "opacity-0 invisible" }`}>
