...
export default function Topnav() {
    ...
    return (
        ...
        <div className={`h-20 duration-500 transition-colors justify-between px-6 xl:px-12 flex items-center w-full ${darkmode ? 'text-white shadow-2xl bg-[#210716] shadow-gray-950 ' : 'shadow-md shadow-gray-500 text-black'}`}>
