  ...
  return (
    <div className={`border-2 border-[#862078] flex flex-col justify-between ${darkmode ? "bg-[#210716]": ""} duration-500 transition-colors h-full p-3 rounded-2xl`}>
      <div className="flex flex-col gap-3">
        {links.map((el, key) => (
          <div className={`flex items-center duration-500 shadow-md transition-colors ${pathname === el[2] ? "bg-[#9DFBFA] text-secondary font-bold" : `${darkmode ? "bg-[#242727] text-[#EBEBEB]": "bg-white text-black"}`} rounded-xl gap-3 `}>
      ...
      <div className="space-y-8">
        ...
        <div className={`${darkmode ? 'bg-[#3C4141]' : 'bg-gray-200'} duration-500 transition-colors relative flex p-2 rounded-xl items-center gap-2`}>
